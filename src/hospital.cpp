...
map<int, user> hospital::usersList;

const int hospital::doctorsLimit = 40;
const int hospital::nursesLimit = 50;
const int hospital::driversLimit = 20;
const int hospital::ambulancesLimit = 20;
const int hospital::appointmentsLimit = 200; //per day;
